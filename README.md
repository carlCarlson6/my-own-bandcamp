...
- Check if album is on label or artist and display it for section "more from ..." — attempted implementation using Bandcamp's `Labels` body class; needs manual review to validate correctness across different page types.
