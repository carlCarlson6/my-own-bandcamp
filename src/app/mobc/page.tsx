...
export default async function MainUserPage() {
  ...
  // TODO - move this ui transformation to the server
  const sections = [
    {
      title: "Pending",
      href: "/mobc/pending",
      items: resume.pending.albums,
      count: resume.pending.count
    },
    {
      title: "Favorites",
      href: "/mobc/favorites",
      items: resume.favorites.albums,
      count: resume.favorites.count
    },
    {
      title: "Listened",
      href: "/mobc/listened",
      items: resume.listened.albums,
      count: resume.listened.count
    },
  ];
